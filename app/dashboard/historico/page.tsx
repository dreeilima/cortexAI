...
import { Search, Trash2, ChevronRight, Filter, Video } from "lucide-react";
import { toast } from "sonner";
import { getVideoHistory, deleteVideo } from "../actions";

interface HistoricoItem {
  id: string;
  nome: string;
  data: string;
  status: "concluido" | "aguardando" | "erro";
  cortesCount: number;
}
...
export default function HistoricoPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold">Histórico de vídeos</h1>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Select value={filter} onValueChange={setFilter}>
          ...
          <SelectContent>
            ...
            <SelectItem value="aguardando">Processando</SelectItem>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Isso removerá o vídeo e todos os cortes associados
          ...
          {filtered.length === 0 && (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                {items.length === 0
                  ? "Nenhum vídeo processado ainda. Envie seu primeiro vídeo!"
